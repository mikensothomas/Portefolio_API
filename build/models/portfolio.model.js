...
const ImagemSchema = new mongoose_1.Schema({
...
const PortfolioSchema = new mongoose_1.Schema({
    ...
    categoria: {
        type: String,
        enum: Object.values(enums_1.CategoryProjects),
        required: true,
    },
    imagem_capa: { type: String },
    status: {
        type: String,
        enum: Object.values(enums_1.StatusProjeto),
        required: true,
    },
...
exports.default = mongoose_1.default.model("Portfolio", PortfolioSchema, "Portfolio");
